...
router.get('subitems/:id', controller.SubItems.GetSubItems);
...
router.delete('item/:id', auth, controller.items.DeleteSubItem);
...
router.delete(
  'subcategory/:id',
  auth,
  controller.subCategories.DeleteSubCategory
);
router.delete(
  'subcategorysub/:id',
  auth,
  controller.subCategorySub.DeleteSubCategorySub
);
...
router.put(
  'subcategorysub/:id',
  auth,
  controller.subCategorySub.UpdateSubCategorySub
);
...
router.post(
  'subcategorysub',
  auth,
  controller.subCategorySub.CreateSubCategorySub
);
